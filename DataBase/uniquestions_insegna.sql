...
CREATE TABLE `insegna` (
  ...
  KEY `id_utente3_idx` (`id_utente`),
  KEY `id_corso2_idx` (`id_corso`),
  CONSTRAINT `id_corso2` FOREIGN KEY (`id_corso`) REFERENCES `corso` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `id_utente3` FOREIGN KEY (`id_utente`) REFERENCES `utente` (`id`) ON DELETE CASCADE ON UPDATE CASCADE

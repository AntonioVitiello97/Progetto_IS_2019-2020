...
CREATE TABLE `lezione` (
  ...
  `data_lezione` varchar(45) NOT NULL,
  `descrizione` varchar(220) NOT NULL,
  `valutazione_media` varchar(45) NOT NULL,
  `id_corso` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `id_corso_idx` (`id_corso`),
  CONSTRAINT `id_corso` FOREIGN KEY (`id_corso`) REFERENCES `corso` (`id`) ON DELETE CASCADE ON UPDATE CASCADE

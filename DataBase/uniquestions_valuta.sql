...
CREATE TABLE `valuta` (
  ...
  KEY `id_utente7_idx` (`id_utente`),
  KEY `id_lezione2_idx` (`id_lezione`),
  CONSTRAINT `id_lezione2` FOREIGN KEY (`id_lezione`) REFERENCES `lezione` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `id_utente7` FOREIGN KEY (`id_utente`) REFERENCES `utente` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
